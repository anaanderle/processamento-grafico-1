...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Viewport no quadrante superior direito
		int width, height;
...
int setupGeometry()
{
	// Triângulo grande em coordenadas de tela (0..800 x 0..600)
	// Escolhido para aparecer claramente mesmo no viewport do quadrante superior direito
	GLfloat vertices[] = {
		// x     y     z    r    g    b
